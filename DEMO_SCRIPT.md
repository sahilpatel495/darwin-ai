...
| Time | Do | Say |
|---|---|---|
| 0:00 | Home, with the nav rail on the left. Hover the rail: Home, Ask, Overview, Analyses, Saved, Trust. | "A raw LLM over a spreadsheet gives confident wrong numbers and ships your data to a third party. For HR that is a non-starter. Verity is what I built around the model. It is not a chat box — six screens, and two of them never call a model at all." |
